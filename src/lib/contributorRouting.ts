...
export type ContributorRedirect = '/contribute' | '/contribute/verify-email' | '/contribute/profile' | '/contribute/dashboard' | null;
 ...
 * no contributor row exists yet. An unconfirmed account is bounced to
 * the verification gate regardless of how it navigated here (a
 * redirect from Step 1/2, or typing the URL directly -- this function
